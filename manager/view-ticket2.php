  ...
  <!-- BEGIN MINI-PROFILE -->
   ...
   <div class="user-info-wrapper">	
    ...
    <div class="user-info">
      ...
      <div class="username"> <span class="semi-bold"><?php echo $_SESSION['name'];?></span></div>
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="300">Ticket Description</th>
                                            ...
                                            <tbody>            
													...
													?>                       
                                                <tr id="trow_1">
                                                    <td style="font-size:12px;" class="text-center"><?=$row['ticket_id'];?></td>
                                                    <td style="font-size:12px;"> <?=$row['subject'];?>  </td>
                                                    <td style="font-size:12px;"><?=$row['task_type'];?></td>
                                                    <td style="font-size:12px;">
													
													<?=$row['prioprity'];?>
												</td>
                                                    <td style="font-size:12px;"><?=$row['ticket'];?></td>
                                                    <td style="font-size:12px;">
                                                       <span class="label label-success"><?=$row['status'];?></span>
                                                    </td>
													<td style="font-size:12px;"><?php $a=$row['admin_remark'];
													if($a==NULL)
													{
													echo "Pending";
													}
