...
if(isset($_POST['submit']))
{
	...
	{
 mysql_query("insert into user(name,email,password,mobile,gender,user_type,posting_date) values('$name','$email','$password','$mobile','$gender','$ut','$date')");
  ...
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          ...
          <p>Use Facebook, Twitter or your email to sign in.<br>
            <a href="index">Sign in Now!</a> for a webarch account,It's free and always will be..</p>
          <br>
