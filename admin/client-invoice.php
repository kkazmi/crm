                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['email'];?></td>
                                                         <td><?php echo $row['mobile'];?></td>
                                                          ...
                                                          <td> 
                                 <a href="create-invoice.php?id=<?php echo $row['id'];?>" class="btn btn-primary btn-xs btn-mini">Create Invoice</a>
                                                        <a href="invoice-client.php?id=<?php echo $row['id'];?>"  class="btn btn-danger btn-xs btn-mini">View All Invoices </a>
                                                          </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1; } ?>
                                                </tbody>
