   ...
   <div class="row">	 
		...
		<div class="col-md-4 col-vlg-3 col-sm-6">
			<div class="tiles gray m-b-10">
              <div class="tiles-body">
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title text-black">Messages </div>
			         <div class="widget-stats">
                      <div class="wrapper transparent">
                      <?php $rt=mysql_query("select * from user");
					  $rw=mysql_num_rows($rt);?> 
						<span class="item-title">Pending Messages</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $rw;?>" data-     animation-duration="700">0</span>
					  </div>
                    </div>
                    <div class="widget-stats ">
                      <div class="wrapper last"> 
					  ...
					  $rt1=mysql_query("select * from user where posting_date='$utd'");
					  $rw1=mysql_num_rows($rt1);?>
						<span class="item-title">Today's Messages</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $rw1;?>" data-animation-duration="700">0</span> 
					 </div>
                    </div>
			  </div>			
			</div>	
		...
		<div class="col-md-4 col-vlg-3 col-sm-6">
			<div class="tiles blue m-b-10">
              <div class="tiles-body">
			  <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <div class="tiles-title text-black">Total Tasks  </div>
			         <div class="widget-stats">
                      <div class="wrapper transparent"> 
                      <?php
                      $qr=mysql_query("select * from prequest");
					  $oq=mysql_num_rows($qr);
					  ?>
						<span class="item-title">All Tasks </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $oq?>" data-animation-duration="700">0</span>
					  </div>
                    </div>
                    <div class="widget-stats">
                      <div class="wrapper transparent">
                       <?php
                      $tsk2=mysql_query("select * from tasks where status='Completed' ");
					  $tk2=mysql_num_rows($tsk2);
					  ?>
						<span class="item-title">Completed  </span> <span class="item-count animate-number semi-bold" data-value="<?php echo $tk2;?>" data-animation-duration="700">0</span> 
					  </div>
                    </div>
